...
const NotificacaoErro: React.FC<NotificacaoProps> = ({ mensagem, aberto }) => {
    ...
    <div x-data="{ open: false }">
      ...
      >
        <button
          ...
          className="fixed right-4 top-4 z-50 rounded-md bg-red-700 px-4 py-2 text-white transition hover:bg-green-600"
        >
